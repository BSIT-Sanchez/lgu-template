    ...
    return(
        <div className="flex h-screen w-full bg-white">
          ...
          <div className='flex justify-between items-center gap-2'>
            ...
            <Link href='/register'className='text-[12px] font-[700] text-[#24336c]'>Sign Up</Link>
          </div>
          ...
          <input type="submit" value="Sign in" className="w-full p-4 bg-[#24336c] mt-4 rounded-md text-[#fff] cursor-pointer font-semibold "/>
        </form>
